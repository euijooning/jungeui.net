...
| Phase | 문서 | 내용 |
|-------|------|------|
| 1 | [phase-01-backoffice-cleanup-and-api.md](phase-01-backoffice-cleanup-and-api.md) | 레거시 제거, API·인증 연동, 대시보드 |
| 2 | [phase-02-posts-and-editor.md](phase-02-posts-and-editor.md) | 글 목록·글 쓰기(TipTap·설정 패널) |
