...
참조: [docs/common/01-db-schema.md](../../docs/common/01-db-schema.md), [docs/common/02-api-spec.md](../../docs/common/02-api-spec.md), [docs/common/03-folder-structure.md](../../docs/common/03-folder-structure.md)
...
| 영역 | 문서 | 내용 |
|------|------|------|
| **전체 레이아웃** | [layout/](layout/) | 레거시 제거, API 연동, 대시보드, 반응형, Phase 체크리스트 |
...
디자인·공통 UI는 [docs/04-design-guide.md](../../docs/common/04-design-guide.md) 및 `shared/ui-kit` 참고.
