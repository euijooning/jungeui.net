...
- [docs/01-db-schema.md](../../../docs/common/01-db-schema.md): posts, categories, tags, post_tags, assets.
- [docs/02-api-spec.md](../../../docs/common/02-api-spec.md): GET/POST/PUT/DELETE /posts, GET /categories, GET /tags, POST /assets/upload.
