...
- [docs/common/01-db-schema.md](../../../docs/common/01-db-schema.md): about_messages 테이블
- [docs/common/02-api-spec.md](../../../docs/common/02-api-spec.md): GET /api/about/messages, GET/POST/PUT/DELETE /api/about_messages
