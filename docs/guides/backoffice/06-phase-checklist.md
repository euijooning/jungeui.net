...
**파일**: `CareerList.jsx`, `ProjectList.jsx`

- [x] **28** CareerList: GET /api/careers, sort_order 순 목록.
- [x] **29** CareerList: 드래그앤드롭 순서 변경 → PATCH /api/careers/reorder.
- [x] **30** CareerList: 등록/수정 폼 — company_name, role, start_date, end_date(NULL=재직중), description, logo_asset_id(POST /api/assets/upload), sort_order, career_links, career_highlights, career_tags.
...
체크리스트 상세는 [05-phase-05-category-management.md](05-phase-05-category-management.md) 참고.
