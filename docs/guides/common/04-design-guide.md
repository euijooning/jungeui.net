...
- 폰트·컬러 팔레트 등 스타일 상수는 백오피스 `AdminTheme.js`(MUI), `index.css`(Tailwind·다크 모드)로 관리. 상세는 [guides/backoffice/07-theme-and-dark-mode.md](../backoffice/07-theme-and-dark-mode.md) 참고.
