...
- **`.carousel-fade`**: 프로젝트 카로셀(About) 좌/우 오버플로우 페이드. `mask-image` linear-gradient로 edge fade. [docs/client/07-project-card-layout.md](../client/07-project-card-layout.md) 참고.
