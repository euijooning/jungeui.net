...
- **페이지**: `apps/backoffice/src/pages/` — `dashboard/Dashboard.jsx`, `posts/PostList.jsx`, `PostDetail.jsx`, `PostNew.jsx`, `PostEdit.jsx`, `PostEditor.jsx`, `careers/CareerList.jsx`, `projects/ProjectList.jsx`, `notifications/NotificationsPage.jsx`.
- **라우트** (App.jsx CustomRoutes): `/`(대시보드), `/posts`, `/posts/new`, `/posts/:postId/edit`, `/posts/:postId`, `/careers`, `/projects`, `/notifications`.

## 참고 문서

- [06-phase-checklist.md](06-phase-checklist.md) — Phase별 체크리스트
- [07-theme-and-dark-mode.md](07-theme-and-dark-mode.md) — 클라이언트 Primary 단일 소스, 백오피스 다크모드
