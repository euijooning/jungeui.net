...
- [x] **30** CareersList: 등록/수정 폼 — company_name, role, start_date, end_date(NULL=재직중), description, logo_asset_id(POST /api/assets/upload), sort_order, career_links, career_highlights, career_tags.
