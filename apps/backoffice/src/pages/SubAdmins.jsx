...
export default function SubAdmins() {
  ...
  // 페이지 타이틀 설정
  useEffect(() => {
    document.title = '서브관리자 관리 | 은혜이음교회';
    return () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">서브관리자 관리</h1>
          <p className="mt-1 text-sm text-gray-500">서브관리자 목록을 관리하고 정보를 수정할 수 있습니다.</p>
        </div>
        <button
