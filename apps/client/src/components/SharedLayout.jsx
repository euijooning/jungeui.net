    ...
    <nav className="relative flex items-center justify-between flex-wrap gap-3 md:flex-nowrap">
      <div className="flex items-center gap-8 md:gap-8">
        ...
        <nav className="flex gap-8 items-center max-[375px]:hidden" aria-label="메인 메뉴">
          ...
          <Link to="/projects" className="theme-nav-link text-lg pb-0.5 border-b border-transparent -mb-px transition-colors">Projects</Link>
          <Link to="/portfolio" className="theme-nav-link text-lg pb-0.5 border-b border-transparent -mb-px transition-colors">Portfolio</Link>
        </nav>
      </div>
          ...
          >
            ...
            <nav aria-label="메인 메뉴">
              <ul className="list-none p-0 m-0">
                ...
                <li className="mb-1">
                  <Link to="/projects" className={linkBase} onClick={() => setMainMenuOverlayOpen(false)}>Projects</Link>
                </li>
                <li className="mb-1">
                  <Link to="/portfolio" className={linkBase} onClick={() => setMainMenuOverlayOpen(false)}>Portfolio</Link>
                </li>
              </ul>
            </nav>
          </div>
